...
INSERT INTO `cucumber`.`order_statuses` (`status`, `status_group`) VALUES ('取り寄せ承認待機', 3);
INSERT INTO `cucumber`.`order_statuses` (`status`, `status_group`) VALUES ('仕入れ待機', 3);
INSERT INTO `cucumber`.`order_statuses` (`status`, `status_group`) VALUES ('仕入れ却下', 4);
INSERT INTO `cucumber`.`order_statuses` (`status`, `status_group`) VALUES ('取り寄せ却下', 4);
INSERT INTO `cucumber`.`order_statuses` (`status`, `status_group`) VALUES ('取り置き却下', 4);
INSERT INTO `cucumber`.`order_statuses` (`status`, `status_group`) VALUES ('引き取り却下', 4);
